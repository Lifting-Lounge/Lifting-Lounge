...
@click.argument("payment", default="cash")
def create_user_command(username, password, email, payment):
    create_user(username, password, email, payment)
...
Forum Commands
'''
forum_cli = AppGroup('forums', help = "commands for exercises")
